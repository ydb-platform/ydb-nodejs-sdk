...
class Session extends events_1.default {
    ...
    async dropTable(tablePath, settings) {
        ...
        const suppressedErrors = (settings === null || settings === void 0 ? void 0 : settings.muteNonExistingTableErrors) ? [errors_1.SchemeError.status] : [];
    ...
    async executeQuery(query, params = {}, txControl = exports.AUTO_TX, settings) {
        ...
        const payload = (0, utils_1.getOperationPayload)(this.processResponseMetadata(request, response, settings === null || settings === void 0 ? void 0 : settings.onResponseMetadata));
...
class TableIndex {
    ...
    withDataColumns(...dataColumns) {
        ...
        if (!this.dataColumns)
            this.dataColumns = [];
        (_a = this.dataColumns) === null || _a === void 0 ? void 0 : _a.push(...dataColumns);
        return this;
    }
