...
var TokenAuthService = /** @class */ (function () {
    function TokenAuthService(token) {
        this.token = token;
    }
    TokenAuthService.prototype.getAuthMetadata = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, add_credentials_to_metadata_1.addCredentialsToMetadata)(this.token)];
            });
        });
    };
