        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = process_ydb_operation_result_1.ensureCallSucceeded;
                    return [4 /*yield*/, this[query_session_1.apiSymbol].beginTransaction({
                            sessionId: this.sessionId,
                            txSettings: txSettings,
                        })];
                case 1:
                    txMeta = _a.apply(void 0, [_b.sent()]).txMeta;
                    if (this[symbols.sessionTxIdSymbol])
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, , 3, 4]);
                    _a = process_ydb_operation_result_1.ensureCallSucceeded;
                    return [4 /*yield*/, this[query_session_1.apiSymbol].commitTransaction({
                            sessionId: this.sessionId,
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, , 3, 4]);
                    _a = process_ydb_operation_result_1.ensureCallSucceeded;
                    return [4 /*yield*/, this[query_session_1.apiSymbol].rollbackTransaction({
                            sessionId: this.sessionId,
                            txId: this[symbols.sessionTxIdSymbol],
                        })];
                case 2: return [2 /*return*/, _a.apply(void 0, [_b.sent()])];
