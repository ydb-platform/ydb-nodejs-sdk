...
var QueryService = function () {
    ...
    return _a = /** @class */ (function (_super) {
            ...
            function QueryService(endpoint, database, authService, logger, sslCredentials, clientOptions) {
                var _this = this;
                var host = endpoint.toString();
                _this = _super.call(this, host, database, 'Ydb.Query.V1.QueryService', exports.GrpcQueryService, authService, sslCredentials, clientOptions) || this;
                _this.endpoint = __runInitializers(_this, _instanceExtraInitializers);
                _this.endpoint = endpoint;
                _this.logger = logger;
                return _this;
            }
            QueryService.prototype.createSession = function () {
        ...
        (function () {
            ...
            _createSession_decorators = [(0, retries_obsoleted_1.retryable)(), utils_1.pessimizable];
            __esDecorate(_a, null, _createSession_decorators, { kind: "method", name: "createSession", static: false, private: false, access: { has: function (obj) { return "createSession" in obj; }, get: function (obj) { return obj.createSession; } }, metadata: _metadata }, null, _instanceExtraInitializers);
...
var QuerySessionPool = /** @class */ (function (_super) {
    ...
    function QuerySessionPool(settings) {
        ...
        _this.discoveryService.on(constants_1.Events.ENDPOINT_REMOVED, function (endpoint) {
            _this.queryServices.delete(endpoint);
        });
        return _this;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!this.queryServices.has(endpoint)) {
                            sessionService = new QueryService(endpoint, this.database, this.authService, this.logger, this.sslCredentials, this.clientOptions);
                            this.queryServices.set(endpoint, sessionService);
                        }
                        return [2 /*return*/, this.queryServices.get(endpoint)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, sessionCreator.createSession()];
                    case 2:
                        session = _a.sent();
