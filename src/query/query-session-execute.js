...
function execute(opts) {
    ...
    // Operation
    responseStream = this[query_session_1.implSymbol].grpcClient.makeServerStreamRequest('/Ydb.Query.V1.QueryService/ExecuteQuery', function (v) { return ydb_sdk_proto_1.Ydb.Query.ExecuteQueryRequest.encode(v).finish(); }, ydb_sdk_proto_1.Ydb.Query.ExecuteQueryResponsePart.decode, ydb_sdk_proto_1.Ydb.Query.ExecuteQueryRequest.create(executeQueryRequest), this[query_session_1.implSymbol].metadata);
    responseStream.on('data', function (partialResp) {
        ...
        if (partialResp.resultSet) {
            ...
            if (!resultSetTuple) {
                ...
                switch (opts.rowMode) {
                    case 1 /* RowType.Ydb */:
                        resultSet_1 = new result_set_1.ResultSet(index, partialResp.resultSet.columns, (_b = opts.rowMode) !== null && _b !== void 0 ? _b : 0 /* RowType.Native */, iterator);
                        break;
                    default: // Native
                        ...
                        resultSet_1 = new result_set_1.ResultSet(index, nativeColumnsNames, (_c = opts.rowMode) !== null && _c !== void 0 ? _c : 0 /* RowType.Native */, iterator);
